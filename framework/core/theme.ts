...
export function generateTheme(seedColorHex: string, isDark: boolean): Theme {
  let r = parseInt(seedColorHex.slice(1, 3), 16) / 255;
  let g = parseInt(seedColorHex.slice(3, 5), 16) / 255;
  let b = parseInt(seedColorHex.slice(5, 7), 16) / 255;
